...
class Type(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self.type_sell_widget.setProperty("class", "type__sell dialog__item__type")
        ...
        self.type_rent_widget.setProperty("class", "type__rent dialog__item__type")
        ...
        self.type_assignment_widget.setProperty("class", "option__assignment dialog__item__type")
    ...
    def set_value(self, option="sell"):
        option_widgets = WidgetHandler.find_widgets_by_class(self, QPushButton, "dialog__item__type")
