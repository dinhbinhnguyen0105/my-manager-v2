...
class Detail(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        self.real_estate_widget.event_payload_changed.connect(self.set_data)
        self.miscellaneous_widget = Misc(self)
        self.miscellaneous_widget.event_payload_changed.connect(self.set_data)
    ...
    def set_data(self, payload):
        ...
        self.event_current_details.emit(self.data)
    
    def get_value(self):
        detail_widgets = WidgetHandler.find_widgets_by_class(self, QFrame, "item__detail")
        for detail_widget in detail_widgets:
            if detail_widget.isHidden(): 
                print(detail_widget.property("user-data"))
            else:
